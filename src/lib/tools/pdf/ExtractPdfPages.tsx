...
export default function ExtractPdfPages() {
  ...
  function run() {
    try { setError(''); setOutput((input || 'Upload a PDF via the picker; page-level actions open locally.')) }
  ...
  return (
    <div className="mx-auto w-full max-w-3xl space-y-4">
      ...
      <Export fileName="ExtractPdfPages-output.txt" data={output} disabled={!output} />
    </div>
  )
}
