...
export default function ImageColorExtractor() {
  ...
  function run() {
    try { setError(''); setOutput((input || 'No image data (paste Base64 or description above)')) }
  ...
  return (
    <div className="mx-auto w-full max-w-3xl space-y-4">
      ...
      <Export fileName="ImageColorExtractor-output.txt" data={output} disabled={!output} />
    </div>
  )
}
